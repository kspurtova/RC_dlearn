...
# ============ Load dataset ============
data = scipy.io.loadmat('/home/docker_user/timeseriesrc/dataset/'+config['dataset_name']+'.mat')
...
accuracy, f1, input_repr_te = classifier.test(Xte, Yte)
...
with open("result_1.txt", "w") as output:
    ...
    output.write(str(f1))
    output.write('\n')
    output.write(str(input_repr_te[0, :10]))

if filecmp.cmp("/home/docker_user/result.txt", "result_1.txt"):
    print("Test passed")
else:
    print("Test failed")
